...
class UserAvatarMenuWidget extends StatelessWidget {
            ...
            Positioned(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  alignment:
                      Alignment.topRight, // L'animazione parte dall'avatar
  ...
  Widget _buildMenuCard(BuildContext context, AuthService authService) {
    final userName = authService.userData?.firstName;
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: Material(
            // Necessario per l'effetto splash dei tasti
            ...
            child: Column(
              ...
              children: [
                ...
                // LOGOUT (Rosso)
                _menuAction(Icons.logout_rounded, "Esci", () async {

...
-- Tabella principale per gli Operatori
...
-- Tabella per i Contatti degli Operatori (corrisponde al campo 'contatti')
...
-- Corretto: Aggiunte zone/attività mancanti o corrette le subquery in base alla lista completa
-- Questo blocco deve essere eseguito DOPO che operatori, zones, e activities sono popolati.
